...
CANNON.BODY_SLEEP_STATES = BODY_SLEEP_STATES;
CANNON.BODY_TYPES = BODY_TYPES;
CANNON.Body = Body;
CANNON.Box = Box;
CANNON.Broadphase = Broadphase;
CANNON.COLLISION_TYPES = COLLISION_TYPES;
...
CANNON.SHAPE_TYPES = SHAPE_TYPES;
